...
class Pow(pg.sprite.Sprite):
    def __init__(self, game, plat):
        ...
        self.game = game
        self.plat = plat
        self.type = choice(['boost'])  # If you want to put more powerup you can add it here
...
class Mob(pg.sprite.Sprite):
    ...
    def update(self):
        ...
        if self.vy > 3 or self.vy < -3:
            self.dy *= -1 # reverse the dy
        # do we use the up or dawn one image
